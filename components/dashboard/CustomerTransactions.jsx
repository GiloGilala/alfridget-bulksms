...
const CustomerTransactions = ({ className }) => {
  const products = [
    {
      id: 1,
      price: 1799,
  ...
  const tableHeaders = [
    { label: "TRANSACTION", className: "py-3 px-6" },
    { label: "PRICE", className: "py-3 px-6" },
    { label: "SOLD", className: "py-3 px-6" },
    { label: "SALES", className: "py-3 px-6 text-end" },
  ];
